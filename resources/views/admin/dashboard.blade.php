                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center file-name-icon">
                                                ...
                                                <div class="ms-2">
                                                    <h6><a href="javascript:void(0);" class="fw-bold">Andrea Willer</a>
                                                    </h6>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center file-name-icon">
                                                ...
                                                <div class="ms-2">
                                                    <h6><a href="javascript:void(0);" class="fw-bold">Timothy Sandsr</a>
                                                    </h6>
                                                    <span class="fs-13 text-orange">#114589</span>
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center file-name-icon">
                                                ...
                                                <div class="ms-2">
                                                    <h6 class="fw-medium"><a href="javascript:void(0);">Randy McCree</a>
                                                    </h6>
                                                    <span class="fs-13 text-orange">#114589</span>
                                                </div>
                                            </div>
                            ...
                            <table class="table table-borderless custom-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>24 May 2025</td>
                                        <td>
                                            <h6 class="fw-medium"><a href="javascript:void(0);">Electricity Payment</a>
                                            </h6>
                                    ...
                                    <tr>
                                        <td>22 May 2025</td>
                                        <td>
                                            <h6 class="fw-medium"><a href="javascript:void(0);">Stationery Purchase</a>
                                            </h6>
                                    ...
                                    <tr>
                                        <td>21 May 2025</td>
                                        <td>
                                            <h6 class="fw-medium"><a href="javascript:void(0);">AC Repair Service</a>
                                            </h6>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center file-name-icon">
                                                ...
                                                <div class="ms-2">
                                                    <h6 class="fw-bold"><a href="javascript:void(0);">Andrea Willer</a>
                                                    </h6>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center file-name-icon">
                                                ...
                                                <div class="ms-2">
                                                    <h6 class="fw-bold"><a href="javascript:void(0);">Timothy Sandsr</a>
                                                    </h6>
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center item-list">
                                <p class="d-inline-flex align-items-center"><i class="ti ti-map-pin me-1"></i>Greenland
                                </p>
                                <p>14 Orders</p>
                            </div>
                        </div>
                ...
                <div class="border br-8">
                    <div class="d-flex align-items-center justify-content-between border-bottom p-2">
                        <p class="d-inline-flex align-items-center mb-0"><i
                                class="ti ti-square-rounded-filled text-indigo fs-8 me-2"></i>Total Number Of Categories
                        </p>
                        <h5>698</h5>
                    </div>
                    <div class="d-flex align-items-center justify-content-between p-2">
                        <p class="d-inline-flex align-items-center mb-0"><i
                                class="ti ti-square-rounded-filled text-orange fs-8 me-2"></i>Total Number Of Products
                        </p>
                        <h5>7899</h5>
                    </div>
                </div>
